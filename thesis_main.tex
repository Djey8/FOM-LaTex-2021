...
\usepackage[a4paper, left=4cm, right=2cm, top=4cm, bottom=2cm,footskip=1cm,footnotesep=1cm,headsep=2cm]{geometry}
...
\vfill
\centering
\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{abbildungen/a4_background_with_box.png}%
\vfill
}}}
...
% Header Linie in Teal, 1pt Dick , mit \subsection namen rechts 
\rohead{\upshape \rightmark}
\KOMAoptions{headsepline=1pt}
\addtokomafont{headsepline}{\color{teal}}

% Footer Seitenzahl rechts, Arbeitstitel links 
\usepackage{lastpage}
\rofoot{\textcolor{teal}{\thepage}}
\lofoot{\upshape \textcolor{gray}{\myTitel}}
...
% We ignore everything for the word count after our fazit
%TC:ignore
